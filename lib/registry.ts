...
export const registry: CategoryEntry[] = [
  {
    ...
    components: [
      { slug: "button", name: "Button", description: "Action triggers with variants, sizes, icons, loading and a glossy accent.", file: "components/ui/button.tsx" },
      ...
      { slug: "dialog", name: "Dialog", description: "Glass modal with backdrop blur and spring entrance.", file: "components/ui/dialog.tsx" },
      { slug: "drawer", name: "Drawer", description: "Side sheet with glass surface and edge-aware animation.", file: "components/ui/drawer.tsx" },
      { slug: "sheet", name: "Bottom Sheet", description: "Vaul-style draggable bottom sheet with snap points and inertia.", file: "components/ui/sheet.tsx" },
      { slug: "tooltip", name: "Tooltip", description: "Glass hover/focus tooltip with delay.", file: "components/ui/tooltip.tsx" },
      { slug: "toast", name: "Toast", description: "Stacked notifications with auto-dismiss.", file: "components/ui/toast.tsx" },
      { slug: "tabs", name: "Tabs", description: "Pill, segment or underline variants with animated indicator.", file: "components/ui/tabs.tsx" },
  ...
  },
  {
    ...
    components: [
      { slug: "spotlight-card", name: "Spotlight Card", description: "Cursor-follow radial glow plus animated gradient border.", file: "components/motion/spotlight-card.tsx" },
      { slug: "tilt-card", name: "Tilt Card", description: "3D perspective tilt on hover with glare.", file: "components/motion/tilt-card.tsx" },
      ...
      { slug: "number-ticker", name: "Number Ticker", description: "Slot-machine digit rolling with staggered entry.", file: "components/motion/number-ticker.tsx" },
    ],
  },
  {
    slug: "data-nav",
    ...
    components: [
      ...
      { slug: "command-k", name: "Command Menu", description: "⌘K palette with glass surface.", file: "components/data-nav/command-k.tsx" },
