          ...
          {registry[0].components.map((comp) => {
            ...
            return (
              <Link
                ...
                className="group relative flex flex-col overflow-hidden rounded-2xl border border-(--color-border) bg-(--color-bg-elev) transition-colors hover:border-(--color-border-strong)"
              >
