  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(50% 60% at 50% 0%, color-mix(in oklch, var(--color-accent) 35%, transparent), transparent 70%)",
        }}
      />
    ...
    <div className="bg-(--color-bg)/40 p-4">
      ...
      <ul className="flex flex-col gap-0.5">
        {[
          ...
          { label: "Components", active: false, badge: "29" },
      ...
      <div className="mt-6 rounded-xl border border-(--color-border) bg-(--color-bg-elev) p-3">
        ...
        <p className="mt-1 text-[11px] text-(--color-fg-muted)">
          BottomSheet, SpotlightCard, NumberTicker.
        </p>
      </div>
    </div>
  );
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <div className="mt-1 flex items-baseline gap-2">
            ...
            />
            <span className="inline-flex items-center gap-0.5 rounded-md bg-(--color-success)/15 px-1.5 py-0.5 text-[11px] font-medium text-(--color-success)">
        ...
        <div className="flex items-center gap-2">
          <button className="inline-flex h-8 w-8 items-center justify-center rounded-md border border-(--color-border) bg-(--color-bg-elev) text-(--color-fg-muted) hover:text-(--color-fg) press">
        ...
        <TabsContent value="billing">
          ...
          <div className="mt-3 flex items-center justify-between rounded-lg border border-(--color-border) bg-(--color-bg-elev) p-4">
            <div className="flex items-center gap-2 text-sm text-(--color-fg)">
              <span className="inline-flex h-5 w-5 items-center justify-center rounded-full bg-(--color-success)/20 text-(--color-success)">
...
function Spark() {
  // Static sparkline path — visual only.
