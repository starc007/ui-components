...
export function SponsorCard() {
  return (
    <section aria-label="Sponsors" className="mt-6 rounded-2xl border border-border p-4">
      ...
      <Link
        ...
        className="mt-3 block rounded-sm focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-ring"
      >
      ...
      <Link
        href="/sponsors"
        className="mt-7 flex items-center justify-between gap-2 rounded-sm text-xs font-medium text-foreground decoration-accent underline-offset-4 hover:underline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-ring"
      >
        Become a sponsor
